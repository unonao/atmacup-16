...
def my_app(cfg: DictConfig) -> None:
    ...
    with utils.timer("make candidates"):
        ...
        train_candidate_df = make_candidates(
            train_log_df, train_session_df, transition_df
        )
        test_candidate_df = make_candidates(test_log_df, test_session_df, transition_df)
